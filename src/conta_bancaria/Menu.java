...
public static void cadastrarConta() {
 ...
 public static void deletarConta() {
	 ...
	 if (conta.isPresent()) {
		 ...
		 System.out.printf("\nTem certeza quue deseja excluir a conta numero %d? (S/N)", numero);
 ...
 public static void atualizarConta() {
	 ...
	 if(conta.isPresent()) {
		//obtem os dados atuais da conta
		 ...
		 System.out.printf("Agencia atual: %d%nDigite o numero da nova agencia(Pressione ENTER para manter o valor atual)", agencia);
		 ...
		 System.out.printf("Saldo atual: %.2f%n Digite o novo saldo (Pressione ENTER para manter o valor atual)", saldo);
		 entrada = leia.nextLine();
		 ...
		 case 2 ->{	 
			 ...
			 int aniversario = contaPoupanca.getDataAniversario();
			 

			 //atualiza o aniversario ou mantem o valor atual
			 System.out.printf("Dia do aniversario atual: %d%nDigite o novo dia do aniversario da conta (Pressione ENTER para manter o valor atual)", aniversario);
			 entrada = leia.nextLine();
			...
			default -> System.out.println(Cores.TEXT_RED + "Tipo da conta é invalido" + Cores.TEXT_RESET); 
		 }		 
